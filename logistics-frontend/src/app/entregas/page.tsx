/*
  Página: Entregas
  Objetivo: listagem/visão visual de entregas (placeholder) com mesmo layout do dashboard.
*/
"use client";
    ...
    <div className={`${inter.className} ${styles.wrapper}`}>
      <aside className={styles.sidebar}>
        ...
        <nav>
          ...
          <Link className={styles.active} aria-current="page" href="/entregas">Entregas</Link>
      ...
      <main className={styles.content}>
        <header className={styles.topbar}>
          <div className={styles.left}><h2>Entregas</h2></div>
        ...
        <section className={styles.grid}>
          <div className={styles.card}>
            <h3>Lista de Entregas (visual)</h3>
            <p className={styles.muted}>Conteúdo placeholder para a página de Entregas.</p>
          </div>
        </section>
      </main>
    </div>
